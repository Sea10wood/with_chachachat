...
const Input = forwardRef<HTMLInputElement, InputProps>((props, ref) => {
  const { label, error, helperText, className = '', id, type, ...rest } = props;
  ...
  const passwordStyles = type === 'password' ? 'pr-10' : '';
    ...
    <div className="space-y-1">
      ...
      <div className="relative">
        <input
          ...
          ref={ref}
          type={inputType}
          className={`${baseStyles} ${borderStyles} ${passwordStyles} ${className}`}
