        ...
        <div className="relative bg-chat-bg rounded-lg shadow">
          ...
          <div className="p-4 md:p-5">
            ...
            <div className="mt-4 flex justify-end">
              <button
                type="button"
                className="text-black bg-send-button hover:bg-loading-color focus:ring-4 focus:outline-none focus:ring-send-button/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center transition-colors duration-200"
                onClick={() => showModal(false)}
              >
                閉じる
              </button>
